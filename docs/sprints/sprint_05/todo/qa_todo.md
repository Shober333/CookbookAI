...
> **Owner:** [DEV-QA]
> **Run date:** 2026-05-04 · **Status:** Local preflight passed; deployed smoke blocked pending Vercel URL and Neon database.
...
- `npx playwright test --project=chromium` — passed, 27/27 Chromium tests.
